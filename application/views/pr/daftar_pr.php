                ...
                <?php $no = 1;
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <a href="<?=site_url('C_pr/delete/'.$data->kode_pr)?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-danger btn-xs">
                                <i class="fa fa-trash"></i> Hapus
                            </a>
                             <a href="<?=site_url('C_pr/ubah/'.$data->kode_pr)?>" class="btn btn-primary btn-xs">
